...
import './IBSApp.css';
import { mcqQuestions, longAnswerQuestions, topicsList } from '../../data/ibsQuestions.js';
...
const Header = ({ currentSection, onNavigate }) => {
  ...
  return (
    <header className="app-header ibs-header">
...
const Dashboard = ({ onStartPractice }) => {
  return (
    <div className="dashboard ibs-dashboard">
      <div className="dashboard-hero">
        <div className="hero-content">
          <h2>Welcome Back!</h2>
          <p>Continue your preparation for CA Final Paper 6: Integrated Business Solutions</p>
        ...
        <div className="hero-visual">
          <div className="circular-progress-large">
            <svg viewBox="0 0 100 100">
              ...
              <circle cx="50" cy="50" r="45" fill="none" stroke="url(#ibs-gradient)" strokeWidth="8" 
                strokeDasharray="283" strokeDashoffset="170" strokeLinecap="round"
                transform="rotate(-90 50 50)"/>
              <defs>
                <linearGradient id="ibs-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <div className="topics-section">
        ...
        <div className="topics-grid">
          {topicsList.map((topic, index) => {
            const progress = Math.floor(Math.random() * 60) + 20; // Placeholder progress
            return (
              <button 
                key={topic.id || index} 
              ...
              >
                ...
                <div className="topic-header">
                  <h4>{topic.name}</h4>
                  <span className="topic-progress">{progress}%</span>
                </div>
...
// MCQ Practice Component with Collapsible Case Study Context
const MCQPractice = () => {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < mcqQuestions.length - 1) {
      ...
      setShowCaseContext(true); // Reset case context visibility
    }
  };
  ...
  return (
    <div className="mcq-practice ibs-mcq">
          ...
          <div className="case-context-panel">
            ...
            >
              <span className="case-context-title">
                ...
                Case Study Context: {currentQuestion.caseStudy}
              </span>
              <svg 
                className={`case-context-arrow ${showCaseContext ? 'expanded' : ''}`}
                viewBox="0 0 24 24" 
                fill="none" 
                stroke="currentColor" 
                strokeWidth="2"
...
const LongAnswerPractice = () => {
  ...
  const getMaxScore = () => {
    return currentQuestion?.rubric?.reduce((sum, r) => sum + r.maxScore, 0) || 0;
  };
  ...
  return (
    <div className="long-answer-practice ibs-long">
      <div className="practice-header">
        <div className="question-nav">
          <button 
            className="nav-arrow" 
