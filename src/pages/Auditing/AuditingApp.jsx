      ...
      <div className="header-content">
        <div className="logo-section">
          ...
          <div className="logo-text">
            <h1>CA Final</h1>
            <span>Advanced Auditing, Assurance & Professional Ethics</span>
          </div>
        </div>
...
const Dashboard = ({ onStartPractice }) => {
  const topics = [
    { name: "Standards on Auditing", mcqs: 6, longAnswers: 1, progress: 45 },
    { name: "Professional Ethics", mcqs: 2, longAnswers: 0, progress: 30 },
    { name: "Company Audit", mcqs: 1, longAnswers: 1, progress: 60 },
    { name: "Bank Audit", mcqs: 2, longAnswers: 0, progress: 20 },
    { name: "NBFC Audit", mcqs: 1, longAnswers: 0, progress: 25 },
    { name: "Public Sector Audit", mcqs: 2, longAnswers: 0, progress: 40 },
    { name: "Internal Audit", mcqs: 1, longAnswers: 0, progress: 35 },
    { name: "Special Audits", mcqs: 1, longAnswers: 1, progress: 50 },
  ];

  return (
    <div className="dashboard auditing-dashboard">
      <div className="dashboard-hero">
        <div className="hero-content">
          <h2>Welcome Back!</h2>
          <p>Continue your preparation for CA Final Paper 3: Advanced Auditing, Assurance & Professional Ethics</p>
          <div className="hero-stats">
            <div className="stat-card">
              <div className="stat-value">{auditingMcqQuestions.length}</div>
        ...
        <div className="hero-visual">
          <div className="circular-progress-large">
            <svg viewBox="0 0 100 100">
              ...
              <circle cx="50" cy="50" r="45" fill="none" stroke="url(#auditing-gradient)" strokeWidth="8" 
                strokeDasharray="283" strokeDashoffset="170" strokeLinecap="round"
                transform="rotate(-90 50 50)"/>
              <defs>
                <linearGradient id="auditing-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <div className="action-cards">
          <button className="action-card mcq-card" onClick={() => onStartPractice('mcq')}>
            ...
            <div className="action-content">
              <h4>MCQ Practice</h4>
              <p>{auditingMcqQuestions.length} questions from past papers</p>
            </div>
          ...
          <button className="action-card long-card" onClick={() => onStartPractice('long')}>
            ...
            <div className="action-content">
              <h4>Long Answers</h4>
              <p>{auditingLongAnswerQuestions.length} comprehensive problems</p>
            </div>
            <div className="action-arrow">→</div>
          </button>
...
const MCQPractice = () => {
  ...
  const currentQuestion = auditingMcqQuestions[currentQuestionIndex];
  ...
  const handleNext = () => {
    if (currentQuestionIndex < auditingMcqQuestions.length - 1) {
      setCurrentQuestionIndex(prev => prev + 1);
      setSelectedAnswer(answers[auditingMcqQuestions[currentQuestionIndex + 1].id] ?? null);
      setIsSubmitted(!!answers[auditingMcqQuestions[currentQuestionIndex + 1].id]);
  ...
  return (
    <div className="mcq-practice auditing-mcq">
      <div className="practice-header">
        <div className="question-nav">
          ...
          <span className="question-counter">
            Question {currentQuestionIndex + 1} of {auditingMcqQuestions.length}
          </span>
          <button 
            className="nav-arrow" 
            onClick={handleNext}
            disabled={currentQuestionIndex === auditingMcqQuestions.length - 1}
          >
            →
          </button>
        </div>
      ...
      <div className="question-palette">
        ...
        <div className="palette-grid">
          {auditingMcqQuestions.map((q, index) => {
...
const LongAnswerPractice = () => {
  ...
  return (
    <div className="long-answer-practice auditing-long">
      <div className="practice-header">
        <div className="question-nav">
          <button 
            className="nav-arrow" 
          ...
          <span className="question-counter">
            Long Answer {currentQuestionIndex + 1} of {auditingLongAnswerQuestions.length}
          </span>
          <button 
            className="nav-arrow" 
            onClick={handleNext}
            disabled={currentQuestionIndex === auditingLongAnswerQuestions.length - 1}
          >
            →
          </button>
        </div>
...
• Provide reasoning for each point"
      ...
      <div className="case-study-palette">
        ...
        <div className="palette-list">
          {auditingLongAnswerQuestions.map((q, index) => (
            <button
              key={q.id}
...
// Main Auditing App Component
function AuditingApp() {
  ...
  return (
    <div className="app auditing-app">
